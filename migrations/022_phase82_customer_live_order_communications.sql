...
CREATE INDEX IF NOT EXISTS idx_customer_live_order_messages_live_order_id ON customer_live_order_messages(live_order_id);
CREATE INDEX IF NOT EXISTS idx_customer_live_order_messages_tenant_id ON customer_live_order_messages(tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_customer_live_order_notification_events_live_order_id ON customer_live_order_notification_events(live_order_id);
