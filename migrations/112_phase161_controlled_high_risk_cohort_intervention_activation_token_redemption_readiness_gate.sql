...
CREATE TABLE IF NOT EXISTS cb_cohort_intervention_activation_token_redempt_readiness (
  ...
  activation_token_redemption_readiness_status VARCHAR(64) NOT NULL DEFAULT 'DRAFT',
  activation_token_redemption_readiness_result VARCHAR(128) NULL,
  ...
  token_redemption_readiness_summary_json JSON NULL,
  impact_review_json JSON NULL,
  rollback_review_json JSON NULL,
  guardrail_review_json JSON NULL,
  token_redemption_readiness_rules_json JSON NULL,
  token_redemption_readiness_blockers_json JSON NULL,
  ...
  activation_token_redemption_readiness_hash VARCHAR(256) NULL,
  token_redemption_readiness_evidence_pack_hash VARCHAR(256) NULL,
  evidence_pack_hash VARCHAR(256) NULL,
  lineage_hash_chain_json JSON NULL,
  redemption_readiness_signatures_json JSON NULL,
  redemption_readiness_metadata_json JSON NULL,
  execution_capability_status VARCHAR(64) NOT NULL DEFAULT 'EXECUTION_NOT_ENABLED',
  activation_execution_status VARCHAR(128) NOT NULL DEFAULT 'TOKEN_REDEMPTION_READINESS_FINALIZED_NOT_REDEEMED_NOT_EXECUTED',
