...
const guardrailSvc = require('../src/api/services/cohortInterventionExecutionPlanActivationTokenRedemptionEnvelopeGuardrailService').serviceInstance;
...
async function setupFinalizedAuth(authId, readinessId, issuanceId) {
  ...
  const issuanceRecord = {
    activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163g',
    source_activation_token_staging_id: 'ats_test_163g', source_activation_token_final_apv_id: 'apv_test_163g',
    source_activation_token_env_id: 'ate_test_163g', source_activation_handoff_id: 'ahf_test_163g',
    source_activation_decision_id: 'dec_test_163g', source_activation_lock_id: 'lock_test_163g',
    source_activation_auth_id: 'auth_test_163g', source_activation_readiness_id: 'rd_test_163g',
    source_plan_id: 'pln_test_163g', source_dispatcher_id: 'dsp_test_163g',
    source_envelope_id: 'env_test_163g', source_auth_id: 'ath_test_163g',
    source_readiness_id: 'rd_test_163g', source_approval_id: 'apv_test_163g', source_prep_id: 'prep_test_163g',
    ...
    source_activation_token_preflight_hash: 'pfl_hash_163g', source_activation_token_staging_hash: 'stg_hash_163g',
    source_token_material_hash: 'token_material_hash_163g', source_freeze_package_hash: 'lock_hash_163g',
    activation_token_issuance_hash: 'iss_hash_163g', token_issuance_evidence_pack_hash: 'ep_hash_163g', evidence_pack_hash: 'ep_hash_163g',
  ...
  const readinessRecord = {
    ...
    source_activation_token_preflight_id: 'atp_test_163g', source_activation_token_staging_id: 'ats_test_163g',
    source_activation_token_final_apv_id: 'apv_test_163g', source_activation_token_env_id: 'ate_test_163g',
    source_activation_handoff_id: 'ahf_test_163g', source_activation_decision_id: 'dec_test_163g',
    source_activation_lock_id: 'lock_test_163g', source_activation_auth_id: 'auth_test_163g',
    source_activation_readiness_id: 'rd_test_163g', source_plan_id: 'pln_test_163g',
    source_dispatcher_id: 'dsp_test_163g', source_envelope_id: 'env_test_163g',
    source_auth_id: 'ath_test_163g', source_readiness_id: 'rd_test_163g',
    source_approval_id: 'apv_test_163g', source_prep_id: 'prep_test_163g',
    ...
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_issuance_hash: 'iss_hash_163g', source_activation_token_preflight_hash: 'pfl_hash_163g',
    source_activation_token_staging_hash: 'stg_hash_163g', source_token_material_hash: 'token_material_hash_163g',
    source_freeze_package_hash: 'lock_hash_163g', activation_token_redemption_readiness_hash: 'rdy_hash_163g',
  ...
  const authRecord = {
    ...
    source_activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163g',
    source_activation_token_staging_id: 'ats_test_163g', source_activation_token_final_apv_id: 'apv_test_163g',
    source_activation_token_env_id: 'ate_test_163g', source_activation_handoff_id: 'ahf_test_163g',
    source_activation_decision_id: 'dec_test_163g', source_activation_lock_id: 'lock_test_163g',
    source_activation_auth_id: 'auth_test_163g', source_activation_readiness_id: 'rd_test_163g',
    ...
    guardrail_status: 'PASS', write_scope_status: 'PASS', canary_envelope_json: config,
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_redemption_readiness_hash: 'rdy_hash_163g', source_activation_token_issuance_hash: 'iss_hash_163g',
    source_activation_token_preflight_hash: 'pfl_hash_163g', source_activation_token_staging_hash: 'stg_hash_163g',
    source_token_material_hash: 'token_material_hash_163g', source_freeze_package_hash: 'lock_hash_163g',
    activation_token_redemption_auth_hash: 'ath_hash_163g', execution_capability_status: 'EXECUTION_NOT_ENABLED',
  ...
  if (!isProdLike) {
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_issuance
       ...
       VALUES (?, 'atp_test_163g', 'ats_test_163g', 'apv_test_163g', 'ate_test_163g', 'ahf_test_163g', 'dec_test_163g', 'lock_test_163g', 'auth_test_163g', 'rd_test_163g', 'pln_test_163g', 'dsp_test_163g', 'env_test_163g', 'ath_test_163g', 'rd_test_163g', 'apv_test_163g', 'prep_test_163g',
        'FINALIZED', 'ISSUANCE_RECORDED_NOT_REDEEMABLE', 'LOW', 'HIGH', 35.0, 80.0, 95.0, 'PASS', 'PASS', '{}', ?, ?,
        'pfl_hash_163g', 'stg_hash_163g', 'token_material_hash_163g', 'lock_hash_163g',
        'iss_hash_163g', 'ep_hash_163g', 'ep_hash_163g',
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_readiness
       ...
       VALUES (?, ?, 'atp_test_163g', 'ats_test_163g', 'apv_test_163g', 'ate_test_163g', 'ahf_test_163g', 'dec_test_163g', 'lock_test_163g', 'auth_test_163g', 'rd_test_163g', 'pln_test_163g', 'dsp_test_163g', 'env_test_163g', 'ath_test_163g', 'rd_test_163g', 'apv_test_163g', 'prep_test_163g',
        ...
        'iss_hash_163g', 'pfl_hash_163g', 'stg_hash_163g', 'token_material_hash_163g', 'lock_hash_163g',
        'rdy_hash_163g', 'EXECUTION_NOT_ENABLED', 'TOKEN_REDEMPTION_READINESS_FINALIZED_NOT_REDEEMED_NOT_EXECUTED', 'FROZEN_IMMUTABLE', 'NOT_EXECUTABLE', 'NO_REAL_JOB_CREATED', 'NO_QUEUE_DISPATCHED', 'ZERO_RUNTIME_MUTATION_CONFIRMED')`,
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_auth
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
               ...
               ?, ?, ?, ?, ?,
               'PASS', 'PASS', ?, '{}', '{}', '{}', '{}', '{}',
               '{}', ?, ?, ?, 'rdy_hash_163g', 'iss_hash_163g', 'pfl_hash_163g', 'stg_hash_163g',
               'token_material_hash_163g', 'lock_hash_163g', 'ath_hash_163g',
...
(async () => {
  console.log('=== Smoke 163G: Guardrails & Safety Boundary Scanner ===\n');

  try {
    const authId = 'ata_163g_1';
    const readinessId = 'atr_163g_1';
    const issuanceId = 'ati_163g_1';
    ...
    // 1. Safety scanner
    const scanFindings = await guardrailSvc.performSafetyScannerCheck(envelopeId);
    ...
    console.log('  PASS: Scanned Phase 163 components - safety boundary clean.');

    // 2. Valid write scope
    const wsFindings = await guardrailSvc.verifyWriteScope(envelopeId);
    ...
    await builder._internalUpdateTokenRedemptionEnvelope(envelopeId, {
      write_scope_attestation_json: { writes_only_phase163_tables: false, wrote_phase128_to_162_operational_tables: true }
    });
    const invalidWsFindings = await guardrailSvc.verifyWriteScope(envelopeId);
    ...
    console.error('FAIL in 163G:', e.message, e.stack);
    process.exit(1);
  } finally {
