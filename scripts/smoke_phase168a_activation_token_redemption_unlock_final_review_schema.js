...
(async () => {
  console.log('=== Smoke 168A: Phase 168 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_frev',
      'cb_cohort_intervention_activation_token_redempt_unlock_frev_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_frev_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_frev_aud'
    ]) {
    ...
    console.error('FAIL in 168A:', e.message);
    process.exit(1);
  } finally {
