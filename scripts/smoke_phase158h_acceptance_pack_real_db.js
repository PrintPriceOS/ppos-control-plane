...
const SMOKE_TESTS = [
  'smoke_phase158a_activation_token_staging_schema.js',
  'smoke_phase158b_create_token_staging_from_phase157_apv.js',
  'smoke_phase158c_activation_token_staging_evaluator_rules.js',
  'smoke_phase158d_activation_token_staging_workflow_governance.js',
  'smoke_phase158e_evidence_pack_v158_lineage.js',
  'smoke_phase158f_admin_api_ui_contract.js',
  'smoke_phase158g_guardrail_staged_not_issued_write_scope.js'
];

(async () => {
  console.log('=== Phase 158 Controlled High-Risk Cohort Intervention Activation Token Staging Gate Acceptance Pack (158H) ===\n');
  ...
  // 1. Validate Phase 157H dependency
  console.log('--- Running Phase 157H dependency check ---');
  try {
    const env = {
      ...process.env,
    ...
    execSync(`node -r dotenv/config scripts/smoke_phase157h_acceptance_pack_real_db.js`, { stdio: 'inherit', env });
    console.log('  PASS: Phase 157H dependency validated successfully.\n');
  } catch (err) {
    console.error('FATAL: Phase 157H dependency check failed. Phase 158 cannot proceed.');
    process.exit(1);
  }

  // 2. Run Phase 158 smoke tests
  console.log('--- Running Phase 158 smoke tests ---');
  let passed = 0;
  let failed = 0;
  ...
  console.log('\n================================================================================');
  console.log('PRINTPRICE OS — PHASE 158');
  console.log('CONTROLLED HIGH-RISK COHORT INTERVENTION ACTIVATION TOKEN STAGING GATE');
  ...
  console.log('TOKEN STAGING: STAGED_NOT_ISSUED');
  console.log('TOKEN STATUS: STAGED_NOT_ISSUED');
  console.log('TOKEN ISSUANCE: STAGED_NOT_ISSUED');
  console.log('TOKEN REDEEMABLE: NOT_REDEEMABLE');
  console.log('ACTIVATION EXECUTION STATUS: TOKEN_STAGING_FINALIZED_NOT_EXECUTED');
  ...
  console.log('WRITE SCOPE: PHASE_158_TABLES_ONLY');
  console.log('================================================================================\n');
