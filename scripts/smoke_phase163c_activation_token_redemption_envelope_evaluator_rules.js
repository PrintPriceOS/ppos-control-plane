...
async function setupFinalizedAuth(authId, readinessId, issuanceId) {
  ...
  const issuanceRecord = {
    activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163c',
    source_activation_token_staging_id: 'ats_test_163c', source_activation_token_final_apv_id: 'apv_test_163c',
    source_activation_token_env_id: 'ate_test_163c', source_activation_handoff_id: 'ahf_test_163c',
    source_activation_decision_id: 'dec_test_163c', source_activation_lock_id: 'lock_test_163c',
    source_activation_auth_id: 'auth_test_163c', source_activation_readiness_id: 'rd_test_163c',
    source_plan_id: 'pln_test_163c', source_dispatcher_id: 'dsp_test_163c',
    source_envelope_id: 'env_test_163c', source_auth_id: 'ath_test_163c',
    source_readiness_id: 'rd_test_163c', source_approval_id: 'apv_test_163c', source_prep_id: 'prep_test_163c',
    ...
    source_activation_token_preflight_hash: 'pfl_hash_163c', source_activation_token_staging_hash: 'stg_hash_163c',
    source_token_material_hash: 'token_material_hash_163c', source_freeze_package_hash: 'lock_hash_163c',
    activation_token_issuance_hash: 'iss_hash_163c', token_issuance_evidence_pack_hash: 'ep_hash_163c', evidence_pack_hash: 'ep_hash_163c',
  ...
  const readinessRecord = {
    ...
    source_activation_token_preflight_id: 'atp_test_163c', source_activation_token_staging_id: 'ats_test_163c',
    source_activation_token_final_apv_id: 'apv_test_163c', source_activation_token_env_id: 'ate_test_163c',
    source_activation_handoff_id: 'ahf_test_163c', source_activation_decision_id: 'dec_test_163c',
    source_activation_lock_id: 'lock_test_163c', source_activation_auth_id: 'auth_test_163c',
    source_activation_readiness_id: 'rd_test_163c', source_plan_id: 'pln_test_163c',
    source_dispatcher_id: 'dsp_test_163c', source_envelope_id: 'env_test_163c',
    source_auth_id: 'ath_test_163c', source_readiness_id: 'rd_test_163c',
    source_approval_id: 'apv_test_163c', source_prep_id: 'prep_test_163c',
    ...
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_issuance_hash: 'iss_hash_163c', source_activation_token_preflight_hash: 'pfl_hash_163c',
    source_activation_token_staging_hash: 'stg_hash_163c', source_token_material_hash: 'token_material_hash_163c',
    source_freeze_package_hash: 'lock_hash_163c', activation_token_redemption_readiness_hash: 'rdy_hash_163c',
  ...
  const authRecord = {
    ...
    source_activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163c',
    source_activation_token_staging_id: 'ats_test_163c', source_activation_token_final_apv_id: 'apv_test_163c',
    source_activation_token_env_id: 'ate_test_163c', source_activation_handoff_id: 'ahf_test_163c',
    source_activation_decision_id: 'dec_test_163c', source_activation_lock_id: 'lock_test_163c',
    source_activation_auth_id: 'auth_test_163c', source_activation_readiness_id: 'rd_test_163c',
    ...
    guardrail_status: 'PASS', write_scope_status: 'PASS', canary_envelope_json: config,
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_redemption_readiness_hash: 'rdy_hash_163c', source_activation_token_issuance_hash: 'iss_hash_163c',
    source_activation_token_preflight_hash: 'pfl_hash_163c', source_activation_token_staging_hash: 'stg_hash_163c',
    source_token_material_hash: 'token_material_hash_163c', source_freeze_package_hash: 'lock_hash_163c',
    activation_token_redemption_auth_hash: 'ath_hash_163c', execution_capability_status: 'EXECUTION_NOT_ENABLED',
  ...
  if (!isProdLike) {
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_issuance
       ...
       VALUES (?, 'atp_test_163c', 'ats_test_163c', 'apv_test_163c', 'ate_test_163c', 'ahf_test_163c', 'dec_test_163c', 'lock_test_163c', 'auth_test_163c', 'rd_test_163c', 'pln_test_163c', 'dsp_test_163c', 'env_test_163c', 'ath_test_163c', 'rd_test_163c', 'apv_test_163c', 'prep_test_163c',
        'FINALIZED', 'ISSUANCE_RECORDED_NOT_REDEEMABLE', 'LOW', 'HIGH', 35.0, 80.0, 95.0, 'PASS', 'PASS', '{}', ?, ?,
        'pfl_hash_163c', 'stg_hash_163c', 'token_material_hash_163c', 'lock_hash_163c',
        'iss_hash_163c', 'ep_hash_163c', 'ep_hash_163c',
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_readiness
       ...
       VALUES (?, ?, 'atp_test_163c', 'ats_test_163c', 'apv_test_163c', 'ate_test_163c', 'ahf_test_163c', 'dec_test_163c', 'lock_test_163c', 'auth_test_163c', 'rd_test_163c', 'pln_test_163c', 'dsp_test_163c', 'env_test_163c', 'ath_test_163c', 'rd_test_163c', 'apv_test_163c', 'prep_test_163c',
        ...
        'iss_hash_163c', 'pfl_hash_163c', 'stg_hash_163c', 'token_material_hash_163c', 'lock_hash_163c',
        'rdy_hash_163c', 'EXECUTION_NOT_ENABLED', 'TOKEN_REDEMPTION_READINESS_FINALIZED_NOT_REDEEMED_NOT_EXECUTED', 'FROZEN_IMMUTABLE', 'NOT_EXECUTABLE', 'NO_REAL_JOB_CREATED', 'NO_QUEUE_DISPATCHED', 'ZERO_RUNTIME_MUTATION_CONFIRMED')`,
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_auth
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
               ...
               ?, ?, ?, ?, ?,
               'PASS', 'PASS', ?, '{}', '{}', '{}', '{}', '{}',
               '{}', ?, ?, ?, 'rdy_hash_163c', 'iss_hash_163c', 'pfl_hash_163c', 'stg_hash_163c',
               'token_material_hash_163c', 'lock_hash_163c', 'ath_hash_163c',
...
(async () => {
  console.log('=== Smoke 163C: Activation Token Redemption Env Evaluator Rules ===\n');

  try {
    const authId1 = 'ata_163c_1';
    const readinessId1 = 'atr_163c_1';
    const issuanceId1 = 'ati_163c_1';
    await setupFinalizedAuth(authId1, readinessId1, issuanceId1);
    const draft1 = await builder.createTokenRedemptionEnvelopeDraft(authId1, 'admin');
    const envelopeId1 = draft1.tokenRedemptionEnvelope.activation_token_redemption_env_id;

    const evalResult1 = await evaluator.evaluateTokenRedemptionEnvelope(envelopeId1, {
    ...
    const rules = await builder.getRules(envelopeId1);
    console.log(`Evaluated rules list for envelopeId1:`, JSON.stringify(rules, null, 2));
    assert.ok(rules.length >= 8, `Expected at least 8 rules, got ${rules.length}`);
    const record1 = await builder.getTokenRedemptionEnvelope(envelopeId1);
    assert.strictEqual(record1.activation_token_redemption_envelope_status, 'EVALUATED');
    assert.strictEqual(record1.activation_token_redemption_envelope_result, 'REDEMPTION_ENVELOPE_PREPARED_NOT_REDEEMED');
    console.log('  PASS: Evaluated redemption envelope record successfully.');

    // 2. Negative case: missing security officer signature
    const authId2 = 'ata_163c_2';
    const readinessId2 = 'atr_163c_2';
    const issuanceId2 = 'ati_163c_2';
    await setupFinalizedAuth(authId2, readinessId2, issuanceId2);
    const draft2 = await builder.createTokenRedemptionEnvelopeDraft(authId2, 'admin');
    const envelopeId2 = draft2.tokenRedemptionEnvelope.activation_token_redemption_env_id;
    const evalResult2 = await evaluator.evaluateTokenRedemptionEnvelope(envelopeId2, {
    ...
    console.error('FAIL in 163C:', e.message, e.stack);
    process.exit(1);
  } finally {
