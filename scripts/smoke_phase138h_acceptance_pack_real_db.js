...
console.log('=== Phase 138 Governed Cohort Intervention Preparation Gate Acceptance Pack (138H) ===\n');
...
(async () => {
  ...
  const smokes = [
    'smoke_phase138a_cohort_intervention_preparation_schema.js',
    'smoke_phase138b_create_preparation_from_phase137_review.js',
    'smoke_phase138c_decision_to_preparation_mapping.js',
    'smoke_phase138d_preparation_lifecycle_governance.js',
    'smoke_phase138e_evidence_pack_builder.js',
    'smoke_phase138f_admin_api_ui_contract.js',
    'smoke_phase138g_guardrail_forbidden_scanner.js',
    ...(hasDb ? ['smoke_phase137h_acceptance_pack_real_db.js'] : [])
  ];
  ...
  console.log(`\nSmoke 138H: Finished execution. ${passed} passed, ${failed} failed`);
  ...
  if (failed > 0 || failedSmokes.length > 0) {
    ...
    console.log('\n================================================================================');
    console.log('PRINTPRICE OS — PHASE 138');
    console.log('GOVERNED COHORT INTERVENTION PREPARATION GATE');
    console.log('STATUS: PRODUCTION-VALIDATED');
    console.log('RESULT: READY');
    console.log('BLOCKERS: NONE');
    console.log('REAL DB VALIDATION: PASSED');
    console.log(`ACCEPTANCE PACK: ${passed} passed, 0 failed`);
    console.log('SAFETY BOUNDARY: PRESERVED');
    console.log('================================================================================');
    process.exit(0);
  }
})().catch(err => {
  console.error('FATAL error in 138H:', err);
  process.exit(1);
});
