...
(async () => {
  console.log('=== Smoke 178A: Phase 178 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_ksdr',
      'cb_cohort_intervention_activation_token_redempt_unlock_ksdr_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_ksdr_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_ksdr_aud'
    ]) {
    ...
    console.error('FAIL in 178A:', e.message);
    process.exit(1);
  } finally {
