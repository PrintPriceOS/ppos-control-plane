...
console.log('=== Smoke 139G: Forbidden Mutation Patterns Scanner ===\n');

try {
  const serviceFiles = [
    'cohortInterventionApprovalBuilderService.js',
    'cohortInterventionApprovalPolicyService.js',
    'cohortInterventionApprovalWorkflowService.js',
    'cohortInterventionApprovalDecisionService.js',
    'cohortInterventionApprovalEvidencePackService.js',
    'cohortInterventionApprovalAuditService.js',
    'cohortInterventionApprovalGuardrailService.js'
  ];

  const routerFiles = [
    'controlledBetaCohortInterventionApprovalAdmin.js'
  ];
  ...
  console.log(`\nSmoke 139G: Finished. ${passed} passed, ${failed} failed.`);
  if (failed > 0) {
    process.exit(1);
  } else {
    process.exit(0);
