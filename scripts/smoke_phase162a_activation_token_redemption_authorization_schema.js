...
(async () => {
  console.log('=== Smoke 162A: Phase 162 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_auth',
      'cb_cohort_intervention_activation_token_redempt_auth_rules',
      'cb_cohort_intervention_activation_token_redempt_auth_ev',
      'cb_cohort_intervention_activation_token_redempt_auth_audits'
    ]) {
    ...
    console.error('FAIL in 162A:', e.message);
    process.exit(1);
  } finally {
