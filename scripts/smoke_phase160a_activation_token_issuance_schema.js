...
(async () => {
  console.log('=== Smoke 160A: Phase 160 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_issuance',
      'cb_cohort_intervention_activation_token_issuance_rules',
      'cb_cohort_intervention_activation_token_issuance_evidence',
      'cb_cohort_intervention_activation_token_issuance_audits'
    ]) {
    ...
    console.error('FAIL in 160A:', e.message);
    process.exit(1);
  } finally {
