...
(async () => {
  console.log('=== Smoke 167A: Phase 167 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_apv',
      'cb_cohort_intervention_activation_token_redempt_unlock_apv_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_apv_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_apv_aud'
    ]) {
    ...
    console.error('FAIL in 167A:', e.message);
    process.exit(1);
  } finally {
