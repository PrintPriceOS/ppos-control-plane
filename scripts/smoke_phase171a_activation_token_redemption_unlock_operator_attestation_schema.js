...
(async () => {
  console.log('=== Smoke 171A: Phase 171 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_oatt',
      'cb_cohort_intervention_activation_token_redempt_unlock_oatt_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_oatt_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_oatt_aud'
    ]) {
    ...
    console.error('FAIL in 171A:', e.message);
    process.exit(1);
  } finally {
