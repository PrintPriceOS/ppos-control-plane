...
(async () => {
  ...
  await runTest('Phase 131 bad decision', async () => {
    await insertExpansionPreparationGateAdaptive(`${runId}_prep_bad_decision`, `${runId}_rev_5`, `${runId}_act_5`, runId);
    ...
    await insertPhase128EvidenceAdaptive(`${runId}_prep_bad_decision`, `${runId}_rev_5`, `${runId}_act_5`, runId);
  }, async () => {
