...
(async () => {
  console.log('=== Smoke 173A: Phase 173 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_fhas',
      'cb_cohort_intervention_activation_token_redempt_unlock_fhas_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_fhas_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_fhas_aud'
    ]) {
    ...
    console.error('FAIL in 173A:', e.message);
    process.exit(1);
  } finally {
