...
(async () => {
  console.log('=== Smoke 163A: Phase 163 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_env',
      'cb_cohort_intervention_activation_token_redempt_env_rules',
      'cb_cohort_intervention_activation_token_redempt_env_ev',
      'cb_cohort_intervention_activation_token_redempt_env_audits'
    ]) {
    ...
    console.error('FAIL in 163A:', e.message);
    process.exit(1);
  } finally {
