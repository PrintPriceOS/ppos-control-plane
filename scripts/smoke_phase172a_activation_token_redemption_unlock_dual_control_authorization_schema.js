...
(async () => {
  console.log('=== Smoke 172A: Phase 172 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_dcau',
      'cb_cohort_intervention_activation_token_redempt_unlock_dcau_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_dcau_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_dcau_aud'
    ]) {
    ...
    console.error('FAIL in 172A:', e.message);
    process.exit(1);
  } finally {
