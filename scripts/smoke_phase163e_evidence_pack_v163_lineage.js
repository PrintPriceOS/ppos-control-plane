...
const evaluator = require('../src/api/services/cohortInterventionExecutionPlanActivationTokenRedemptionEnvelopeEvaluatorService').serviceInstance;
const decisionSvc = require('../src/api/services/cohortInterventionExecutionPlanActivationTokenRedemptionEnvelopeDecisionService').serviceInstance;
const evidenceSvc = require('../src/api/services/cohortInterventionExecutionPlanActivationTokenRedemptionEnvelopeEvidencePackService').serviceInstance;
...
async function setupFinalizedAuth(authId, readinessId, issuanceId) {
  ...
  const issuanceRecord = {
    activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163e',
    source_activation_token_staging_id: 'ats_test_163e', source_activation_token_final_apv_id: 'apv_test_163e',
    source_activation_token_env_id: 'ate_test_163e', source_activation_handoff_id: 'ahf_test_163e',
    source_activation_decision_id: 'dec_test_163e', source_activation_lock_id: 'lock_test_163e',
    source_activation_auth_id: 'auth_test_163e', source_activation_readiness_id: 'rd_test_163e',
    source_plan_id: 'pln_test_163e', source_dispatcher_id: 'dsp_test_163e',
    source_envelope_id: 'env_test_163e', source_auth_id: 'ath_test_163e',
    source_readiness_id: 'rd_test_163e', source_approval_id: 'apv_test_163e', source_prep_id: 'prep_test_163e',
    ...
    source_activation_token_preflight_hash: 'pfl_hash_163e', source_activation_token_staging_hash: 'stg_hash_163e',
    source_token_material_hash: 'token_material_hash_163e', source_freeze_package_hash: 'lock_hash_163e',
    activation_token_issuance_hash: 'iss_hash_163e', token_issuance_evidence_pack_hash: 'ep_hash_163e', evidence_pack_hash: 'ep_hash_163e',
  ...
  const readinessRecord = {
    ...
    source_activation_token_preflight_id: 'atp_test_163e', source_activation_token_staging_id: 'ats_test_163e',
    source_activation_token_final_apv_id: 'apv_test_163e', source_activation_token_env_id: 'ate_test_163e',
    source_activation_handoff_id: 'ahf_test_163e', source_activation_decision_id: 'dec_test_163e',
    source_activation_lock_id: 'lock_test_163e', source_activation_auth_id: 'auth_test_163e',
    source_activation_readiness_id: 'rd_test_163e', source_plan_id: 'pln_test_163e',
    source_dispatcher_id: 'dsp_test_163e', source_envelope_id: 'env_test_163e',
    source_auth_id: 'ath_test_163e', source_readiness_id: 'rd_test_163e',
    source_approval_id: 'apv_test_163e', source_prep_id: 'prep_test_163e',
    ...
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_issuance_hash: 'iss_hash_163e', source_activation_token_preflight_hash: 'pfl_hash_163e',
    source_activation_token_staging_hash: 'stg_hash_163e', source_token_material_hash: 'token_material_hash_163e',
    source_freeze_package_hash: 'lock_hash_163e', activation_token_redemption_readiness_hash: 'rdy_hash_163e',
  ...
  const authRecord = {
    ...
    source_activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163e',
    source_activation_token_staging_id: 'ats_test_163e', source_activation_token_final_apv_id: 'apv_test_163e',
    source_activation_token_env_id: 'ate_test_163e', source_activation_handoff_id: 'ahf_test_163e',
    source_activation_decision_id: 'dec_test_163e', source_activation_lock_id: 'lock_test_163e',
    source_activation_auth_id: 'auth_test_163e', source_activation_readiness_id: 'rd_test_163e',
    ...
    guardrail_status: 'PASS', write_scope_status: 'PASS', canary_envelope_json: config,
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_redemption_readiness_hash: 'rdy_hash_163e', source_activation_token_issuance_hash: 'iss_hash_163e',
    source_activation_token_preflight_hash: 'pfl_hash_163e', source_activation_token_staging_hash: 'stg_hash_163e',
    source_token_material_hash: 'token_material_hash_163e', source_freeze_package_hash: 'lock_hash_163e',
    activation_token_redemption_auth_hash: 'ath_hash_163e', execution_capability_status: 'EXECUTION_NOT_ENABLED',
  ...
  if (!isProdLike) {
    ...
    await db.query('DELETE FROM cb_cohort_intervention_activation_token_redempt_auth_ev WHERE activation_token_redemption_auth_id = ?', [authId]);
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_issuance
       ...
       VALUES (?, 'atp_test_163e', 'ats_test_163e', 'apv_test_163e', 'ate_test_163e', 'ahf_test_163e', 'dec_test_163e', 'lock_test_163e', 'auth_test_163e', 'rd_test_163e', 'pln_test_163e', 'dsp_test_163e', 'env_test_163e', 'ath_test_163e', 'rd_test_163e', 'apv_test_163e', 'prep_test_163e',
        'FINALIZED', 'ISSUANCE_RECORDED_NOT_REDEEMABLE', 'LOW', 'HIGH', 35.0, 80.0, 95.0, 'PASS', 'PASS', '{}', ?, ?,
        'pfl_hash_163e', 'stg_hash_163e', 'token_material_hash_163e', 'lock_hash_163e',
        'iss_hash_163e', 'ep_hash_163e', 'ep_hash_163e',
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_readiness
       ...
       VALUES (?, ?, 'atp_test_163e', 'ats_test_163e', 'apv_test_163e', 'ate_test_163e', 'ahf_test_163e', 'dec_test_163e', 'lock_test_163e', 'auth_test_163e', 'rd_test_163e', 'pln_test_163e', 'dsp_test_163e', 'env_test_163e', 'ath_test_163e', 'rd_test_163e', 'apv_test_163e', 'prep_test_163e',
        ...
        'iss_hash_163e', 'pfl_hash_163e', 'stg_hash_163e', 'token_material_hash_163e', 'lock_hash_163e',
        'rdy_hash_163e', 'EXECUTION_NOT_ENABLED', 'TOKEN_REDEMPTION_READINESS_FINALIZED_NOT_REDEEMED_NOT_EXECUTED', 'FROZEN_IMMUTABLE', 'NOT_EXECUTABLE', 'NO_REAL_JOB_CREATED', 'NO_QUEUE_DISPATCHED', 'ZERO_RUNTIME_MUTATION_CONFIRMED')`,
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_auth
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
               ...
               ?, ?, ?, ?, ?,
               'PASS', 'PASS', ?, '{}', '{}', '{}', '{}', '{}',
               '{}', ?, ?, ?, 'rdy_hash_163e', 'iss_hash_163e', 'pfl_hash_163e', 'stg_hash_163e',
               'token_material_hash_163e', 'lock_hash_163e', 'ath_hash_163e',
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_auth_ev 
       ...
       VALUES ('ev_ath_163e_prev', ?, '162.0', 'ath_ep_hash_163e', '{}', '{}')`,
      [authId]
    );
  }
}
...
(async () => {
  console.log('=== Smoke 163E: Evidence Pack Builder & Lineage ===\n');

  try {
    const authId = 'ata_163e_1';
    const readinessId = 'atr_163e_1';
    const issuanceId = 'ati_163e_1';
    await setupFinalizedAuth(authId, readinessId, issuanceId);

    const draft = await builder.createTokenRedemptionEnvelopeDraft(authId, 'admin');
    const envelopeId = draft.tokenRedemptionEnvelope.activation_token_redemption_env_id;

    await evaluator.evaluateTokenRedemptionEnvelope(envelopeId, {
      security_officer_confirmed: true, compliance_officer_confirmed: true, operations_director_confirmed: true
    }, 'admin');
    await decisionSvc.recordDecision(envelopeId, 'APPROVE', 'Signing evidence envelope', 'admin');
    const finalRecord = await decisionSvc.finalizeRedemptionEnvelope(envelopeId, 'admin');

    if (isProdLike) {
      const rows = await db.query(
        `SELECT * FROM cb_cohort_intervention_activation_token_redempt_env_ev WHERE activation_token_redemption_envelope_id = ?`,
        [envelopeId]
      );
    ...
    console.log('  PASS: Evidence schema version is 163.0.');

    const testPayload = { redacted_system_token_material: '[REDACTED_SECURE_TOKEN_MATERIAL_REDEMPTION_ENVELOPE_ONLY]' };
    ...
    assert.ok('phase162' in ep.lineageHashChain, 'phase162 missing from lineage chain');
    assert.ok('phase163_token_redemption_envelope' in ep.lineageHashChain, 'phase163_token_redemption_envelope missing from lineage chain');
    console.log('  PASS: Lineage chain validation complete.');

    console.log('\nSmoke 163E: Passed.');
    process.exit(0);
  } catch (e) {
    console.error('FAIL in 163E:', e.message, e.stack);
    process.exit(1);
  } finally {
