...
(async () => {
  console.log('=== Smoke 170A: Phase 170 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_pfrz',
      'cb_cohort_intervention_activation_token_redempt_unlock_pfrz_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_pfrz_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_pfrz_aud'
    ]) {
    ...
    console.error('FAIL in 170A:', e.message);
    process.exit(1);
  } finally {
