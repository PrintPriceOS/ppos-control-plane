...
(async () => {
  console.log('=== Smoke 176A: Phase 176 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_lph',
      'cb_cohort_intervention_activation_token_redempt_unlock_lph_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_lph_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_lph_aud'
    ]) {
    ...
    console.error('FAIL in 176A:', e.message);
    process.exit(1);
  } finally {
