...
(async () => {
  console.log('=== Smoke 165A: Phase 165 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_lock',
      'cb_cohort_intervention_activation_token_redempt_lock_rules',
      'cb_cohort_intervention_activation_token_redempt_lock_ev',
      'cb_cohort_intervention_activation_token_redempt_lock_audits'
    ]) {
    ...
    console.error('FAIL in 165A:', e.message);
    process.exit(1);
  } finally {
