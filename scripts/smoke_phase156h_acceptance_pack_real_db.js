...
const SMOKE_TESTS = [
  'smoke_phase156a_activation_token_env_schema.js',
  'smoke_phase156b_create_token_env_from_phase155_auth.js',
  'smoke_phase156c_activation_token_env_evaluator_rules.js',
  'smoke_phase156d_activation_token_env_workflow_governance.js',
  'smoke_phase156e_evidence_pack_v156_lineage.js',
  'smoke_phase156f_admin_api_ui_contract.js',
  'smoke_phase156g_guardrail_envelope_prepared_not_issued_write_scope.js'
];

(async () => {
  console.log('=== Phase 156 Controlled High-Risk Cohort Intervention Activation Token Issuance Envelope Gate Acceptance Pack (156H) ===\n');
  ...
  // 1. Validate Phase 155H dependency
  console.log('--- Running Phase 155H dependency check ---');
  try {
    const env = {
      ...process.env,
    ...
    execSync(`node -r dotenv/config scripts/smoke_phase155h_acceptance_pack_real_db.js`, { stdio: 'inherit', env });
    console.log('  PASS: Phase 155H dependency validated successfully.\n');
  } catch (err) {
    console.error('FATAL: Phase 155H dependency check failed. Phase 156 cannot proceed.');
    process.exit(1);
  }

  // 2. Run Phase 156 smoke tests
  console.log('--- Running Phase 156 smoke tests ---');
  let passed = 0;
  let failed = 0;
  ...
  console.log('\n================================================================================');
  console.log('PRINTPRICE OS — PHASE 156');
  console.log('CONTROLLED HIGH-RISK COHORT INTERVENTION ACTIVATION TOKEN ISSUANCE ENVELOPE GATE');
  ...
  console.log('TOKEN ENVELOPE: ENVELOPE_PREPARED_NOT_ISSUED');
  console.log('TOKEN STATUS: PREPARED_NOT_ISSUED');
  console.log('TOKEN ISSUANCE: ENVELOPE_PREPARED_NOT_ISSUED');
  console.log('TOKEN REDEEMABLE: NOT_REDEEMABLE');
  console.log('ACTIVATION EXECUTION STATUS: TOKEN_ENV_FINALIZED_NOT_EXECUTED');
  ...
  console.log('WRITE SCOPE: PHASE_156_TABLES_ONLY');
  console.log('================================================================================\n');
