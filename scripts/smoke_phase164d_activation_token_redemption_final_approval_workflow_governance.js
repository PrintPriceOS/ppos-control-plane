...
async function setupFinalizedEnv(envId, authId, readinessId, issuanceId) {
  ...
  const issuanceRecord = {
    activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_164d',
    source_activation_token_staging_id: 'ats_test_164d', source_activation_token_final_apv_id: 'apv_test_164d',
    source_activation_token_env_id: 'ate_test_164d', source_activation_handoff_id: 'ahf_test_164d',
    source_activation_decision_id: 'dec_test_164d', source_activation_lock_id: 'lock_test_164d',
    source_activation_auth_id: 'auth_test_164d', source_activation_readiness_id: 'rd_test_164d',
    source_plan_id: 'pln_test_164d', source_dispatcher_id: 'dsp_test_164d',
    source_envelope_id: 'env_test_164d', source_auth_id: 'ath_test_164d',
    source_readiness_id: 'rd_test_164d', source_approval_id: 'apv_test_164d', source_prep_id: 'prep_test_164d',
    ...
    source_activation_token_preflight_hash: 'pfl_hash_164d', source_activation_token_staging_hash: 'stg_hash_164d',
    source_token_material_hash: 'token_material_hash_164d', source_freeze_package_hash: 'lock_hash_164d',
    activation_token_issuance_hash: 'iss_hash_164d', token_issuance_evidence_pack_hash: 'ep_hash_164d', evidence_pack_hash: 'ep_hash_164d',
  ...
  const readinessRecord = {
    ...
    source_activation_token_preflight_id: 'atp_test_164d', source_activation_token_staging_id: 'ats_test_164d',
    source_activation_token_final_apv_id: 'apv_test_164d', source_activation_token_env_id: 'ate_test_164d',
    source_activation_handoff_id: 'ahf_test_164d', source_activation_decision_id: 'dec_test_164d',
    source_activation_lock_id: 'lock_test_164d', source_activation_auth_id: 'auth_test_164d',
    source_activation_readiness_id: 'rd_test_164d', source_plan_id: 'pln_test_164d',
    source_dispatcher_id: 'dsp_test_164d', source_envelope_id: 'env_test_164d',
    source_auth_id: 'ath_test_164d', source_readiness_id: 'rd_test_164d',
    source_approval_id: 'apv_test_164d', source_prep_id: 'prep_test_164d',
    ...
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_issuance_hash: 'iss_hash_164d', source_activation_token_preflight_hash: 'pfl_hash_164d',
    source_activation_token_staging_hash: 'stg_hash_164d', source_token_material_hash: 'token_material_hash_164d',
    source_freeze_package_hash: 'lock_hash_164d', activation_token_redemption_readiness_hash: 'rdy_hash_164d',
  ...
  const authRecord = {
    ...
    source_activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_164d',
    source_activation_token_staging_id: 'ats_test_164d', source_activation_token_final_apv_id: 'apv_test_164d',
    source_activation_token_env_id: 'ate_test_164d', source_activation_handoff_id: 'ahf_test_164d',
    source_activation_decision_id: 'dec_test_164d', source_activation_lock_id: 'lock_test_164d',
    source_activation_auth_id: 'auth_test_164d', source_activation_readiness_id: 'rd_test_164d',
    ...
    guardrail_status: 'PASS', write_scope_status: 'PASS', canary_envelope_json: config,
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_redemption_readiness_hash: 'rdy_hash_164d', source_activation_token_issuance_hash: 'iss_hash_164d',
    source_activation_token_preflight_hash: 'pfl_hash_164d', source_activation_token_staging_hash: 'stg_hash_164d',
    source_token_material_hash: 'token_material_hash_164d', source_freeze_package_hash: 'lock_hash_164d',
    activation_token_redemption_auth_hash: 'ath_hash_164d', execution_capability_status: 'EXECUTION_NOT_ENABLED',
  ...
  const envRecord = {
    ...
    guardrail_status: 'PASS', write_scope_status: 'PASS', canary_envelope_json: config,
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_redemption_authorization_hash: 'ath_hash_164d',
    source_activation_token_redemption_readiness_hash: 'rdy_hash_164d', source_activation_token_issuance_hash: 'iss_hash_164d',
    source_activation_token_preflight_hash: 'pfl_hash_164d', source_activation_token_staging_hash: 'stg_hash_164d',
    source_token_material_hash: 'token_material_hash_164d', source_freeze_package_hash: 'lock_hash_164d',
    activation_token_redemption_envelope_hash: 'env_hash_164d', execution_capability_status: 'EXECUTION_NOT_ENABLED',
  ...
  if (!isProdLike) {
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_issuance
       ...
       VALUES (?, 'atp_test_164d', 'ats_test_164d', 'apv_test_164d', 'ate_test_164d', 'ahf_test_164d', 'dec_test_164d', 'lock_test_164d', 'auth_test_164d', 'rd_test_164d', 'pln_test_164d', 'dsp_test_164d', 'env_test_164d', 'ath_test_164d', 'rd_test_164d', 'apv_test_164d', 'prep_test_164d',
        'FINALIZED', 'ISSUANCE_RECORDED_NOT_REDEEMABLE', 'LOW', 'HIGH', 35.0, 80.0, 95.0, 'PASS', 'PASS', '{}', ?, ?,
        'pfl_hash_164d', 'stg_hash_164d', 'token_material_hash_164d', 'lock_hash_164d',
        'iss_hash_164d', 'ep_hash_164d', 'ep_hash_164d',
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_readiness
       ...
       VALUES (?, ?, 'atp_test_164d', 'ats_test_164d', 'apv_test_164d', 'ate_test_164d', 'ahf_test_164d', 'dec_test_164d', 'lock_test_164d', 'auth_test_164d', 'rd_test_164d', 'pln_test_164d', 'dsp_test_164d', 'env_test_164d', 'ath_test_164d', 'rd_test_164d', 'apv_test_164d', 'prep_test_164d',
        ...
        'iss_hash_164d', 'pfl_hash_164d', 'stg_hash_164d', 'token_material_hash_164d', 'lock_hash_164d',
        'rdy_hash_164d', 'EXECUTION_NOT_ENABLED', 'TOKEN_REDEMPTION_READINESS_FINALIZED_NOT_REDEEMED_NOT_EXECUTED', 'FROZEN_IMMUTABLE', 'NOT_EXECUTABLE', 'NO_REAL_JOB_CREATED', 'NO_QUEUE_DISPATCHED', 'ZERO_RUNTIME_MUTATION_CONFIRMED')`,
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_auth
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
               ...
               ?, ?, ?, ?, ?,
               'PASS', 'PASS', ?, '{}', '{}', '{}', '{}', '{}',
               '{}', ?, ?, ?, 'rdy_hash_164d', 'iss_hash_164d', 'pfl_hash_164d', 'stg_hash_164d',
               'token_material_hash_164d', 'lock_hash_164d', 'ath_hash_164d',
    ...
    await db.query(
      ...
      [
        ...
        'ath_hash_164d', 'rdy_hash_164d', 'iss_hash_164d', 'pfl_hash_164d', 'stg_hash_164d', 'token_material_hash_164d', 'lock_hash_164d'
      ]
    );
  }
}
...
(async () => {
  console.log('=== Smoke 164D: Review Workflow Governance ===\n');

  try {
    const envId = 'ate_164d_1';
    const authId = 'ata_164d_1';
    const readinessId = 'atr_164d_1';
    const issuanceId = 'ati_164d_1';
    ...
    await assert.rejects(
      decisionSvc.finalizeRedemptionFinalApproval(approvalId, 'admin'),
      /TOKEN_REDEMPTION_FINAL_APPROVAL_NOT_PASSED/
    );
    ...
    await decisionSvc.recordDecision(approvalId, 'APPROVE', 'Recording final approval event', 'admin');
    const passedRecord = await builder.getTokenRedemptionFinalApproval(approvalId);
    assert.strictEqual(passedRecord.activation_token_redemption_final_apv_status, 'FINAL_APV_PASSED');

    const finalRecord = await decisionSvc.finalizeRedemptionFinalApproval(approvalId, 'admin');
    assert.strictEqual(finalRecord.activation_token_redemption_final_apv_status, 'FINALIZED');
    assert.strictEqual(finalRecord.activation_token_redemption_final_apv_result, 'REDEMPTION_FINAL_APPROVED_NOT_REDEEMED');
    ...
    console.log('  PASS: Activation token redemption final approval finalized successfully.');

    // 3. Mutations blocked on finalized record
    await assert.rejects(
      builder.updateTokenRedemptionFinalApproval(approvalId, { activation_token_redemption_final_apv_status: 'DRAFT' }),
      /TOKEN_REDEMPTION_FINAL_APPROVAL_IMMUTABLE/
    );
    console.log('  PASS: Modifications blocked on finalized token redemption final approval.');

    console.log('\nSmoke 164D: Passed.');
    process.exit(0);
  } catch (e) {
    console.error('FAIL in 164D:', e.message, e.stack);
    process.exit(1);
  } finally {
