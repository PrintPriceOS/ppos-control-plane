...
async function setupFinalizedAuth(authId, readinessId, issuanceId) {
  ...
  const issuanceRecord = {
    activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163d',
    source_activation_token_staging_id: 'ats_test_163d', source_activation_token_final_apv_id: 'apv_test_163d',
    source_activation_token_env_id: 'ate_test_163d', source_activation_handoff_id: 'ahf_test_163d',
    source_activation_decision_id: 'dec_test_163d', source_activation_lock_id: 'lock_test_163d',
    source_activation_auth_id: 'auth_test_163d', source_activation_readiness_id: 'rd_test_163d',
    source_plan_id: 'pln_test_163d', source_dispatcher_id: 'dsp_test_163d',
    source_envelope_id: 'env_test_163d', source_auth_id: 'ath_test_163d',
    source_readiness_id: 'rd_test_163d', source_approval_id: 'apv_test_163d', source_prep_id: 'prep_test_163d',
    ...
    source_activation_token_preflight_hash: 'pfl_hash_163d', source_activation_token_staging_hash: 'stg_hash_163d',
    source_token_material_hash: 'token_material_hash_163d', source_freeze_package_hash: 'lock_hash_163d',
    activation_token_issuance_hash: 'iss_hash_163d', token_issuance_evidence_pack_hash: 'ep_hash_163d', evidence_pack_hash: 'ep_hash_163d',
  ...
  const readinessRecord = {
    ...
    source_activation_token_preflight_id: 'atp_test_163d', source_activation_token_staging_id: 'ats_test_163d',
    source_activation_token_final_apv_id: 'apv_test_163d', source_activation_token_env_id: 'ate_test_163d',
    source_activation_handoff_id: 'ahf_test_163d', source_activation_decision_id: 'dec_test_163d',
    source_activation_lock_id: 'lock_test_163d', source_activation_auth_id: 'auth_test_163d',
    source_activation_readiness_id: 'rd_test_163d', source_plan_id: 'pln_test_163d',
    source_dispatcher_id: 'dsp_test_163d', source_envelope_id: 'env_test_163d',
    source_auth_id: 'ath_test_163d', source_readiness_id: 'rd_test_163d',
    source_approval_id: 'apv_test_163d', source_prep_id: 'prep_test_163d',
    ...
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_issuance_hash: 'iss_hash_163d', source_activation_token_preflight_hash: 'pfl_hash_163d',
    source_activation_token_staging_hash: 'stg_hash_163d', source_token_material_hash: 'token_material_hash_163d',
    source_freeze_package_hash: 'lock_hash_163d', activation_token_redemption_readiness_hash: 'rdy_hash_163d',
  ...
  const authRecord = {
    ...
    source_activation_token_issuance_id: issuanceId, source_activation_token_preflight_id: 'atp_test_163d',
    source_activation_token_staging_id: 'ats_test_163d', source_activation_token_final_apv_id: 'apv_test_163d',
    source_activation_token_env_id: 'ate_test_163d', source_activation_handoff_id: 'ahf_test_163d',
    source_activation_decision_id: 'dec_test_163d', source_activation_lock_id: 'lock_test_163d',
    source_activation_auth_id: 'auth_test_163d', source_activation_readiness_id: 'rd_test_163d',
    ...
    guardrail_status: 'PASS', write_scope_status: 'PASS', canary_envelope_json: config,
    non_execution_attestation_json: nonExecution, write_scope_attestation_json: writeScope,
    source_activation_token_redemption_readiness_hash: 'rdy_hash_163d', source_activation_token_issuance_hash: 'iss_hash_163d',
    source_activation_token_preflight_hash: 'pfl_hash_163d', source_activation_token_staging_hash: 'stg_hash_163d',
    source_token_material_hash: 'token_material_hash_163d', source_freeze_package_hash: 'lock_hash_163d',
    activation_token_redemption_auth_hash: 'ath_hash_163d', execution_capability_status: 'EXECUTION_NOT_ENABLED',
  ...
  if (!isProdLike) {
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_issuance
       ...
       VALUES (?, 'atp_test_163d', 'ats_test_163d', 'apv_test_163d', 'ate_test_163d', 'ahf_test_163d', 'dec_test_163d', 'lock_test_163d', 'auth_test_163d', 'rd_test_163d', 'pln_test_163d', 'dsp_test_163d', 'env_test_163d', 'ath_test_163d', 'rd_test_163d', 'apv_test_163d', 'prep_test_163d',
        'FINALIZED', 'ISSUANCE_RECORDED_NOT_REDEEMABLE', 'LOW', 'HIGH', 35.0, 80.0, 95.0, 'PASS', 'PASS', '{}', ?, ?,
        'pfl_hash_163d', 'stg_hash_163d', 'token_material_hash_163d', 'lock_hash_163d',
        'iss_hash_163d', 'ep_hash_163d', 'ep_hash_163d',
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_readiness
       ...
       VALUES (?, ?, 'atp_test_163d', 'ats_test_163d', 'apv_test_163d', 'ate_test_163d', 'ahf_test_163d', 'dec_test_163d', 'lock_test_163d', 'auth_test_163d', 'rd_test_163d', 'pln_test_163d', 'dsp_test_163d', 'env_test_163d', 'ath_test_163d', 'rd_test_163d', 'apv_test_163d', 'prep_test_163d',
        ...
        'iss_hash_163d', 'pfl_hash_163d', 'stg_hash_163d', 'token_material_hash_163d', 'lock_hash_163d',
        'rdy_hash_163d', 'EXECUTION_NOT_ENABLED', 'TOKEN_REDEMPTION_READINESS_FINALIZED_NOT_REDEEMED_NOT_EXECUTED', 'FROZEN_IMMUTABLE', 'NOT_EXECUTABLE', 'NO_REAL_JOB_CREATED', 'NO_QUEUE_DISPATCHED', 'ZERO_RUNTIME_MUTATION_CONFIRMED')`,
    ...
    await db.query(
      `INSERT INTO cb_cohort_intervention_activation_token_redempt_auth
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,
               ...
               ?, ?, ?, ?, ?,
               'PASS', 'PASS', ?, '{}', '{}', '{}', '{}', '{}',
               '{}', ?, ?, ?, 'rdy_hash_163d', 'iss_hash_163d', 'pfl_hash_163d', 'stg_hash_163d',
               'token_material_hash_163d', 'lock_hash_163d', 'ath_hash_163d',
...
(async () => {
  console.log('=== Smoke 163D: Review Workflow Governance ===\n');

  try {
    const authId = 'ata_163d_1';
    const readinessId = 'atr_163d_1';
    const issuanceId = 'ati_163d_1';
    ...
    await assert.rejects(
      decisionSvc.finalizeRedemptionEnvelope(envelopeId, 'admin'),
      /TOKEN_REDEMPTION_ENVELOPE_NOT_PASSED/
    );
    ...
    await decisionSvc.recordDecision(envelopeId, 'APPROVE', 'Recording envelope event', 'admin');
    const passedRecord = await builder.getTokenRedemptionEnvelope(envelopeId);
    assert.strictEqual(passedRecord.activation_token_redemption_envelope_status, 'ENVELOPE_PASSED');

    const finalRecord = await decisionSvc.finalizeRedemptionEnvelope(envelopeId, 'admin');
    assert.strictEqual(finalRecord.activation_token_redemption_envelope_status, 'FINALIZED');
    assert.strictEqual(finalRecord.activation_token_redemption_envelope_result, 'REDEMPTION_ENVELOPE_PREPARED_NOT_REDEEMED');
    ...
    console.log('  PASS: Activation token redemption envelope finalized successfully with safe non-execution markers.');

    // 3. Mutations blocked on finalized record
    await assert.rejects(
      builder.updateTokenRedemptionEnvelope(envelopeId, { activation_token_redemption_envelope_status: 'DRAFT' }),
      /TOKEN_REDEMPTION_ENVELOPE_IMMUTABLE/
    );
    console.log('  PASS: Modifications blocked on finalized token redemption envelope.');

    console.log('\nSmoke 163D: Passed.');
    process.exit(0);
  } catch (e) {
    console.error('FAIL in 163D:', e.message, e.stack);
    process.exit(1);
  } finally {
