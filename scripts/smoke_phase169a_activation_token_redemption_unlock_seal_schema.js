...
(async () => {
  console.log('=== Smoke 169A: Phase 169 Schema Validation ===\n');
  ...
  try {
    for (const tableName of [
      'cb_cohort_intervention_activation_token_redempt_unlock_seal',
      'cb_cohort_intervention_activation_token_redempt_unlock_seal_rl',
      'cb_cohort_intervention_activation_token_redempt_unlock_seal_ev',
      'cb_cohort_intervention_activation_token_redempt_unlock_seal_aud'
    ]) {
    ...
    console.error('FAIL in 169A:', e.message);
    process.exit(1);
  } finally {
