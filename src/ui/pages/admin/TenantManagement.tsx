...
const BillingViewer = ({ tenantId, onClose }: { tenantId: string; onClose: () => void }) => {
    ...
    return (
        <div className="mt-4 p-5 bg-indigo-500/5 border border-indigo-500/20 animate-in slide-in-from-top duration-300 relative overflow-hidden">
...
const BillingStat = ({ label, value }: { label: string; value: any }) => (
    <div className="bg-white/5 p-3 border border-indigo-500/20">
                        ...
                        >
                            ...
                            <div className="p-6">
                                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                                    <div className="space-y-3 flex-1">
                                        <div className="flex items-center gap-3 flex-wrap">
                                            ...
                                            {isHighUsageRisk && (
                                                <span className="px-2 py-0.5 text-[10px] font-bold bg-amber-500/10 text-amber-500 border border-amber-500/20">
                                                    HIGH USAGE
                                                </span>
                                            )}
                                            {expiryWarning && (
                                                <span className="flex items-center gap-1 text-amber-500 bg-amber-500/10 px-2 py-0.5 text-[10px] font-black border border-amber-500/20 uppercase animate-pulse">
                                        ...
                                        <div className="flex items-end gap-6 pt-2">
                                            <div className="flex-1 space-y-1.5">
                                                ...
                                                <div className="h-2 w-full bg-white/5 overflow-hidden border border-white/10">
                                                    <div
                                                        className={`h-full transition-all duration-1000 ${usagePercent >= 100 ? 'bg-rose-500' :
                                    ...
                                    <div className="flex flex-col items-end gap-3 min-w-[140px]">
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-black font-bold hover:bg-white/90 transition-all active:scale-95"
                                        >
                                ...
                                {tenant.alerts_state_json?.fired?.length ? (
                                    <div className="mt-4 p-3 bg-rose-500/10 border border-rose-500/20 flex items-center gap-3">
                            ...
                            <div className="px-6 py-3 bg-white/5 border-t border-white/10 flex items-center justify-between text-xs font-medium text-slate-400">
                    ...
                    <div className="bg-white dark:bg-black border border-white/10 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200 shadow-[0_0_50px_rgba(0,0,0,1)]">
                        ...
                        <div className="p-6 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3">
                            <button
                                ...
                                className="px-6 py-2 text-slate-400 font-bold hover:bg-white/5 transition-colors"
                            >
                                Cancel
                            </button>
                            <button
