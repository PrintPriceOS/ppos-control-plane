                ...
                <div className="bg-white rounded-none-[2rem] border border-slate-200 p-6 shadow-none">
                    ...
                    <div className="space-y-4">
                        {(predictions.data?.predictions || []).map((p: any) => (
                            <div key={p.id} className="p-4 bg-slate-50 border border-slate-100 rounded-none flex items-center justify-between group hover:border-red-200 transition-all">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-none border-4 border-white shadow-none flex items-center justify-center bg-white overflow-hidden relative">
                                ...
                                <div className="text-right">
                                    ...
                                    <button className="px-3 py-1 bg-white border border-slate-200 text-[10px] font-black text-blue-600 rounded-none hover:bg-blue-50 transition-all">AUTO-REROUTE</button>
                                </div>
                            </div>
                        ))}
                ...
                <div className="bg-slate-50 rounded-none-[2rem] border border-slate-200 p-6 shadow-none">
                    ...
                    <div className="space-y-3">
                        {(congestion.data?.forecasts || []).slice(0, 6).map((f: any) => (
                            <div key={f.node_id} className="p-4 bg-white rounded-none border border-slate-100 flex items-center justify-between">
                ...
                <div className="bg-white rounded-none-[2rem] border border-slate-200 p-6 shadow-none">
                    ...
                    <div className="space-y-4">
                        {(optimization.data?.cycles || []).slice(0, 5).map((c: any) => (
                            <div key={c.id} className="p-4 bg-slate-50 border border-slate-100 rounded-none flex items-center gap-4">
