                            ...
                            <div className="bg-white rounded-none border border-slate-200 p-6 shadow-none">
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="flex gap-2">
                                        <span className={`px-3 py-1 rounded-none text-[10px] font-black tracking-widest uppercase border ${selectedSession.selection_mode === 'ADMIN_OVERRIDE' ? 'bg-amber-50 text-amber-700 border-amber-200' : 'bg-slate-50 text-slate-600 border-slate-200'
                                            }`}>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {selectedSession.offers.map((o: any, i: number) => (
                                        <div key={i} className={`p-4 rounded-none border transition-all ${o.offer_selected ? 'bg-emerald-50/50 border-emerald-200 ring-2 ring-emerald-500/10' : 'bg-white border-slate-100 hover:border-slate-300 shadow-none'
                                            }`}>
