    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="space-y-4 mt-6">
                {audit.length === 0 ? (
                    <div className="text-center p-8 text-slate-400 border-2 border-dashed rounded-none">No global incidents requiring coordination detected.</div>
                ) : audit.map((a, i) => (
                    <div key={i} className="bg-amber-50 border border-amber-200 rounded-none p-5 shadow-sm text-sm">
                        ...
                        <div className="bg-white/50 p-2 rounded-none font-mono text-xs text-amber-800 border border-amber-100">
