        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            <div className="flex justify-between items-center border-b pb-4">
                ...
                <div className="space-x-2">
                    <Link to="/global/policies" className="px-3 py-1 bg-slate-100 text-slate-700 rounded-none text-sm hover:bg-slate-200">Policy Registry</Link>
                    <Link to="/global/rollouts" className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-none text-sm hover:bg-indigo-100">Active Rollouts</Link>
                    <Link to="/global/posture" className="px-3 py-1 bg-amber-50 text-amber-700 rounded-none text-sm hover:bg-amber-100">Global Posture</Link>
                    <Link to="/global/conflicts" className="px-3 py-1 bg-red-50 text-red-700 rounded-none text-sm hover:bg-red-100">Sovereignty Conflicts</Link>
                </div>
            </div>
            ...
            <div className="p-4 bg-indigo-50 text-indigo-900 rounded-none text-sm border border-indigo-200">
