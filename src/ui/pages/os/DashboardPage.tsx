...
export const DashboardPage: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">OS Control Center</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Global governance, real-time vitals, and infrastructure coordination.</p>
                </div>
                ...
                <div className="lg:col-span-2 glass rounded-2xl border border-white dark:border-slate-700/30 p-6 flex flex-col gap-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Active Governance Blocks</h3>
                        </div>
                    ...
                    <div className="space-y-4 italic-text-off">
                        ...
                        {gov.data?.blocks?.length === 0 && (
                            <p className="text-xs text-slate-400 dark:text-slate-500 text-center py-4">No active governance blocks</p>
                        )}
                    </div>
                </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-center gap-2">
                         <div className="relative">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <span className="text-[8px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Efficiency</span>
                            </div>
                         </div>
                         <p className="text-sm font-bold text-slate-900 dark:text-slate-100 mt-2">12/12 Workers Active</p>
                         <p className="text-[10px] text-slate-400 dark:text-slate-500 font-black uppercase tracking-widest">Regional Cluster eu-west-1</p>
                    </div>
                </div>
            </div>
        </div>
