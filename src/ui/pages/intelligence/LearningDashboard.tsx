    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <Link to="/intelligence/learning/strategies" className="block p-6 bg-white rounded-none border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <Link to="/intelligence/learning/outcomes" className="block p-6 bg-white rounded-none border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <Link to="/intelligence/learning/confidence" className="block p-6 bg-white rounded-none border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-none p-6 mt-8">
                <div className="flex items-center gap-3">
                    <div className="w-3 h-3 rounded-none bg-indigo-500 animate-pulse"></div>
