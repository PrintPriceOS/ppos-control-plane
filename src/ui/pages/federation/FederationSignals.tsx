...
export const FederationSignals: React.FC = () => {
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            <div className="bg-slate-900 rounded-none overflow-hidden shadow-sm mt-4 p-4 font-mono text-sm">
                {signals.length === 0 ? (
                    ...
                    <div key={i} className="border-l-4 border-indigo-500 pl-4 py-2 mb-3 last:mb-0">
                        <div className="flex gap-4 items-center mb-1">
                            ...
                            <span className="text-white bg-indigo-900 px-2 rounded-none">{s.signalType}</span>
                            <span className="text-slate-400">ORIGIN: {s.origin}</span>
                        </div>
                        <div className="text-slate-300 bg-slate-800 p-2 rounded-none mt-2 overflow-x-auto text-xs">
