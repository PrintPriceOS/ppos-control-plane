                    ...
                    <tbody>
                        {audit.length === 0 ? (
                            ...
                            <tr key={i} className="border-b last:border-0 hover:bg-slate-50">
                                ...
                                <td className="p-4"><span className="bg-slate-200 text-slate-700 px-2 py-0.5 rounded-none font-bold text-xs">{a.originInstance}</span></td>
                                <td className="p-4"><span className="bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-none font-bold text-xs">{a.targetInstance}</span></td>
