...
import { COUNTRIES, getCountryName, getCountryDisplayName } from '../lib/countryCatalog';
                                        ...
                                        <div style={{ position: 'relative' }}>
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    const found = COUNTRIES.find(c => c.name.toLowerCase() === text.toLowerCase() || c.code.toLowerCase() === text.toLowerCase());
                                                    setFormData(p => ({ ...p, country: found ? found.code : text.toUpperCase() }));
                                                }}
                                                style={{
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr', gap: '8px', borderBottom: `1px solid ${dark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)'}`, paddingBottom: '8px' }}>
                                            ...
                                            <span style={{ fontSize: '13px', fontWeight: 700, color: dark ? '#f4f4f5' : '#0f172a' }}>{formData.city}, {getCountryDisplayName(formData.country)}</span>
                                        </div>
                                        <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr', gap: '8px', borderBottom: `1px solid ${dark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)'}`, paddingBottom: '8px' }}>
