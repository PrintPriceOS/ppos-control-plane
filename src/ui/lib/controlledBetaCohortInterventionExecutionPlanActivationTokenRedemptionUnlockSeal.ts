export interface TokenRedemptionUnlockSeal {
  activation_token_redemption_unlock_seal_id: string;
  ...
  unlock_seal_status: 'DRAFT' | 'EVALUATED' | 'APPROVED' | 'REJECTED' | 'FINALIZED' | 'BLOCKED';
  unlock_seal_result: 'PENDING' | 'UNLOCK_READINESS_SEALED_NOT_UNLOCKED' | 'UNLOCK_READINESS_SEAL_FAILED' | 'UNLOCK_READINESS_SEAL_BLOCKED_BY_FINAL_REVIEW' | 'UNLOCK_READINESS_SEAL_BLOCKED_BY_GUARDRAIL';
  unlock_seal_mode: string;
  ...
  unlock_seal_summary_json: any;
  impact_review_json: any;
  rollback_review_json: any;
  guardrail_review_json: any;
  unlock_seal_rules_json: any;
  unlock_seal_blockers_json: any;
  ...
  unlock_seal_hash: string;
  unlock_seal_evidence_pack_hash: string;
  evidence_pack_hash: string;
  lineage_hash_chain_json: any;
  security_signature_json: any;
  seal_rationale_json: any;
...
export interface UnlockSealRule {
  rule_id: string;
  activation_token_redemption_unlock_seal_id: string;
  check_type: string;
