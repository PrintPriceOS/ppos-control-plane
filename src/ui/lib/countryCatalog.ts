 ...
 *
 * Canonical Master Country Catalog & Region Preset Utility.
 *
 * Contains the complete officially assigned ISO 3166-1 alpha-2 standard dataset (~249 entities)
 * with uppercase 2-letter codes, official display names, and UI helper presets.
 */
