export interface ControlledBetaCohortInterventionExecutionPlanActivationTokenRedemptionUnlockGovernanceReadinessClosure {
  ...
  unlock_governance_readiness_closure_status: string;
  unlock_governance_readiness_closure_result: string;
  unlock_governance_readiness_closure_mode: string;
  ...
  governance_closure_confirmed_at?: string;
  governance_closure_reason?: string;
  created_at: string;
  updated_at: string;
  created_by: string;
  updated_by: string;
...
export interface GovernanceReadinessClosureConfirmations {
  governance_readiness_closure_confirmation: boolean;
  phase160_to_phase179_chain_complete_confirmed: boolean;
  final_non_execution_evidence_seal_verified: boolean;
  ...
  operator_attestation_verified: boolean;
  pre_execution_freeze_verified: boolean;
  readiness_seal_verified: boolean;
  final_review_verified: boolean;
