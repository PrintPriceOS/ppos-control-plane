export interface TokenRedemptionUnlockApproval {
  activation_token_redemption_unlock_approval_id: string;
  ...
  unlock_approval_status: 'DRAFT' | 'EVALUATED' | 'APPROVED' | 'REJECTED' | 'FINALIZED' | 'BLOCKED';
  unlock_approval_result: 'PENDING' | 'UNLOCK_APPROVAL_PASSED_NOT_UNLOCKED' | 'UNLOCK_APPROVAL_FAILED' | 'UNLOCK_APPROVAL_BLOCKED_BY_ELIGIBILITY' | 'UNLOCK_APPROVAL_BLOCKED_BY_GUARDRAIL';
  ...
  unlock_approval_summary_json: any;
  impact_review_json: any;
  rollback_review_json: any;
  guardrail_review_json: any;
  unlock_approval_rules_json: any;
  unlock_approval_blockers_json: any;
  ...
  unlock_approval_hash: string;
  unlock_approval_evidence_pack_hash: string;
  evidence_pack_hash: string;
  lineage_hash_chain_json: any;
  security_signature_json: any;
  approval_rationale_json: any;
...
export interface UnlockApprovalRule {
  rule_id: string;
  activation_token_redemption_unlock_approval_id: string;
  check_type: string;
