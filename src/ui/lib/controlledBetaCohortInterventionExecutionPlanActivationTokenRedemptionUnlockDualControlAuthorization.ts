export interface TokenRedemptionUnlockDualControlAuthorization {
  activation_token_redemption_unlock_dual_control_authorization_id: string;
  ...
  unlock_dual_control_authorization_status: 'DRAFT' | 'EVALUATED' | 'APPROVED' | 'REJECTED' | 'FINALIZED' | 'BLOCKED';
  unlock_dual_control_authorization_result: 'PENDING' | 'DUAL_CONTROL_AUTHORIZED_NOT_UNLOCKED' | 'DUAL_CONTROL_AUTHORIZATION_FAILED' | 'DUAL_CONTROL_AUTHORIZATION_BLOCKED_BY_OPERATOR_ATTESTATION' | 'DUAL_CONTROL_AUTHORIZATION_BLOCKED_BY_GUARDRAIL';
  unlock_dual_control_authorization_mode: string;
  ...
  unlock_dual_control_authorization_summary_json: any;
  impact_review_json: any;
  rollback_review_json: any;
  guardrail_review_json: any;
  unlock_dual_control_authorization_rules_json: any;
  unlock_dual_control_authorization_blockers_json: any;
  ...
  unlock_dual_control_authorization_hash: string;
  unlock_dual_control_authorization_evidence_pack_hash: string;
  ...
  primary_authorizer_id: string | null;
  primary_authorizer_role: string | null;
  primary_authorized_at: string | null;
  secondary_authorizer_id: string | null;
  secondary_authorizer_role: string | null;
  secondary_authorized_at: string | null;
  dual_control_separation_attestation_json: any;
  approved_by?: string;
  approved_at?: string;
  rejected_by?: string;
  rejected_at?: string;
...
export interface UnlockDualControlAuthorizationRule {
  rule_id: string;
  activation_token_redemption_unlock_dual_control_authorization_id: string;
  check_type: string;
