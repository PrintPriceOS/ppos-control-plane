export interface TokenRedemptionUnlockLegalPolicyHold {
  act_token_redempt_unlock_legal_policy_hold_id: string;
  ...
  unlock_legal_policy_hold_status: 'DRAFT' | 'EVALUATED' | 'APPROVED' | 'REJECTED' | 'FINALIZED' | 'BLOCKED';
  unlock_legal_policy_hold_result:
    | 'LEGAL_POLICY_HOLD_CLEARED_NOT_UNLOCKED'
    | 'LEGAL_POLICY_HOLD_ACTIVE_BLOCKED'
    | 'LEGAL_POLICY_HOLD_CONFIRMATION_FAILED'
    | 'LEGAL_POLICY_HOLD_BLOCKED_BY_RISK_COUNTERSIGN'
    | 'LEGAL_POLICY_HOLD_BLOCKED_BY_GUARDRAIL';
  unlock_legal_policy_hold_mode: 'LEGAL_POLICY_HOLD_CONFIRMATION_ONLY';
  unlock_risk_officer_countersign_status: string;
  ...
  unlock_legal_policy_hold_summary_json: string;
  impact_review_json: string;
  rollback_review_json: string;
  guardrail_review_json: string;
  unlock_legal_policy_hold_rules_json: string;
  unlock_legal_policy_hold_blockers_json: string;
  non_execution_attestation_json: string;
  write_scope_attestation_json: string;
  source_unlock_risk_officer_countersign_hash: string;
  ...
  unlock_legal_policy_hold_hash: string;
  unlock_legal_policy_hold_evidence_pack_hash: string;
  ...
  legal_policy_confirmed_at?: string;
  legal_policy_hold_confirmation_reason?: string;
  legal_policy_hold_registry_snapshot_json?: string;
  legal_policy_hold_attestation_json?: string;
