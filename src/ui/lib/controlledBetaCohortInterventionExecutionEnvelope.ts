export interface EnvelopeRecord {
  ...
  envelope_status: 'DRAFT' | 'READY_FOR_EVALUATION' | 'EVALUATED' | 'READY_FOR_NO_OP_RUN' | 'NO_OP_RUN_COMPLETED' | 'FINALIZED' | 'BLOCKED' | 'FAILED' | 'SUPERSEDED';
...
export interface EnvelopeRuleCheck {
  rule_id: string;
  envelope_id: string;
  check_type: string;
  severity: string;
