export interface DecisionRecord {
  ...
  activation_decision_status: 'DRAFT' | 'READY_FOR_EVALUATION' | 'EVALUATED' | 'READY_FOR_DECISION' | 'GO_APPROVED' | 'NO_GO_DECIDED' | 'FINALIZED' | 'BLOCKED' | 'FAILED' | 'SUPERSEDED';
  activation_decision_result: string | null;
  risk_level: string;
