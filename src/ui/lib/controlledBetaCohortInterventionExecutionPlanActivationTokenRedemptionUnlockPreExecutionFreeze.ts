export interface TokenRedemptionUnlockPreExecutionFreeze {
  activation_token_redemption_unlock_pre_execution_freeze_id: string;
  ...
  unlock_pre_execution_freeze_status: 'DRAFT' | 'EVALUATED' | 'APPROVED' | 'REJECTED' | 'FINALIZED' | 'BLOCKED';
  unlock_pre_execution_freeze_result: 'PENDING' | 'UNLOCK_PRE_EXECUTION_FROZEN_NOT_UNLOCKED' | 'UNLOCK_PRE_EXECUTION_FREEZE_FAILED' | 'UNLOCK_PRE_EXECUTION_FREEZE_BLOCKED_BY_SEAL' | 'UNLOCK_PRE_EXECUTION_FREEZE_BLOCKED_BY_GUARDRAIL';
  unlock_pre_execution_freeze_mode: string;
  ...
  unlock_pre_execution_freeze_summary_json: any;
  impact_review_json: any;
  rollback_review_json: any;
  guardrail_review_json: any;
  unlock_pre_execution_freeze_rules_json: any;
  unlock_pre_execution_freeze_blockers_json: any;
  ...
  unlock_pre_execution_freeze_hash: string;
  unlock_pre_execution_freeze_evidence_pack_hash: string;
  evidence_pack_hash: string;
  lineage_hash_chain_json: any;
  security_signature_json: any;
  freeze_rationale_json: any;
...
export interface UnlockPreExecutionFreezeRule {
  rule_id: string;
  activation_token_redemption_unlock_pre_execution_freeze_id: string;
  check_type: string;
