export interface TokenRedemptionUnlockFinalReview {
  activation_token_redemption_unlock_final_review_id: string;
  ...
  unlock_final_review_status: 'DRAFT' | 'EVALUATED' | 'APPROVED' | 'REJECTED' | 'FINALIZED' | 'BLOCKED';
  unlock_final_review_result: 'PENDING' | 'FINAL_REVIEW_PASSED_NOT_UNLOCKED' | 'FINAL_REVIEW_FAILED' | 'FINAL_REVIEW_BLOCKED_BY_APPROVAL' | 'FINAL_REVIEW_BLOCKED_BY_GUARDRAIL';
  ...
  unlock_final_review_summary_json: any;
  impact_review_json: any;
  rollback_review_json: any;
  guardrail_review_json: any;
  unlock_final_review_rules_json: any;
  unlock_final_review_blockers_json: any;
  ...
  unlock_final_review_hash: string;
  unlock_final_review_evidence_pack_hash: string;
  evidence_pack_hash: string;
  lineage_hash_chain_json: any;
  security_signature_json: any;
  final_review_rationale_json: any;
...
export interface UnlockFinalReviewRule {
  rule_id: string;
  activation_token_redemption_unlock_final_review_id: string;
  check_type: string;
