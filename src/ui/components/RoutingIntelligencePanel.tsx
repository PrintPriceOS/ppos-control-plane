            ...
            <div className="p-6 space-y-6">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="px-2 py-0.5 bg-rose-100 text-rose-700 rounded-none text-[9px] font-black uppercase">
                ...
                <div className="pt-4 border-t border-slate-100">
                    <button className="w-full py-3 bg-indigo-600 text-white rounded-none text-[10px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 flex items-center justify-center gap-2">
