...
export const LiveDispatchMap: React.FC = () => {
    ...
    return (
        <div className="relative w-full h-[700px] bg-[#050505] border border-white/10 rounded-sm overflow-hidden group">
            {/* Grid Overlay */}
            ...
            <div className="absolute top-6 left-6 flex flex-col gap-4 pointer-events-none">
                <div className="p-4 bg-black/60 backdrop-blur-md border border-white/10 rounded-sm">
                    <h2 className="text-[10px] font-black text-white uppercase tracking-[0.3em] mb-4">Federation Dispatch Live</h2>
                    <div className="space-y-3">
                        <div className="flex justify-between items-center gap-12">
                            <span className="text-[8px] font-bold text-slate-500 uppercase">Active Routes</span>
                            <span className="text-xs font-black text-primary tabular-nums">{mapState?.summary?.active_dispatches || 0}</span>
                        </div>
                        <div className="flex justify-between items-center gap-12">
                            <span className="text-[8px] font-bold text-slate-500 uppercase">Operational Nodes</span>
            ...
            {/* Legend */}
            <div className="absolute bottom-6 right-6 flex items-center gap-6 p-3 bg-black/40 border border-white/5 rounded-sm">
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                    <span className="text-[7px] font-black text-slate-400 uppercase">Online</span>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-amber-500" />
                    <span className="text-[7px] font-black text-slate-400 uppercase">Degraded</span>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-red-500" />
                    <span className="text-[7px] font-black text-slate-400 uppercase">Saturation</span>
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-3 h-[1px] bg-red-500/40 border-t border-dashed border-red-500/60" />
                    <span className="text-[7px] font-black text-slate-400 uppercase">Active Route</span>
                </div>
            </div>
