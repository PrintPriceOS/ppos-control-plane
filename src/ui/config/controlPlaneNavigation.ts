...
export const navigationConfig: NavItem[] = [
    ...
    { id: 'dashboard', label: 'Dashboard', path: '/dashboard', icon: 'HomeIcon', roles: ['SUPER_ADMIN', 'OPS_ADMIN', 'TENANT_ADMIN', 'PRINTHOUSE_ADMIN', 'PRINTHOUSE_OPERATOR'] },
    ...
    { id: 'settings', label: 'Settings', path: '/settings', icon: 'Cog6ToothIcon', roles: ['SUPER_ADMIN', 'PRINTHOUSE_ADMIN', 'TENANT_ADMIN'] },
];
