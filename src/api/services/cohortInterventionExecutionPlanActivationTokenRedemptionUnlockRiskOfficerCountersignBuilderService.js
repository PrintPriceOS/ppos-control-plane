...
class CohortInterventionExecutionPlanActivationTokenRedemptionUnlockRiskOfficerCountersignBuilderService {
  ...
  async getTokenRedemptionUnlockRiskOfficerCountersign(unlockRiskOfficerCountersignId) {
    if (!isProdLike) {
      ...
      parsed.unlock_risk_officer_countersign_summary_json = parseJsonField(parsed.unlock_risk_officer_countersign_summary_json, {});
      ...
      parsed.unlock_risk_officer_countersign_rules_json = parseJsonField(parsed.unlock_risk_officer_countersign_rules_json, {});
      parsed.unlock_risk_officer_countersign_blockers_json = parseJsonField(parsed.unlock_risk_officer_countersign_blockers_json, {});
      ...
      parsed.risk_officer_countersign_payload_json = parseJsonField(parsed.risk_officer_countersign_payload_json, {});
      parsed.safety_snapshot_json = parseJsonField(parsed.safety_snapshot_json, {});
      parsed.risk_officer_countersign_attestation_json = parseJsonField(parsed.risk_officer_countersign_attestation_json, {});
    ...
    r.unlock_risk_officer_countersign_summary_json = parseJsonField(r.unlock_risk_officer_countersign_summary_json, {});
    ...
    r.unlock_risk_officer_countersign_rules_json = parseJsonField(r.unlock_risk_officer_countersign_rules_json, {});
    r.unlock_risk_officer_countersign_blockers_json = parseJsonField(r.unlock_risk_officer_countersign_blockers_json, {});
    ...
    r.risk_officer_countersign_payload_json = parseJsonField(r.risk_officer_countersign_payload_json, {});
    r.safety_snapshot_json = parseJsonField(r.safety_snapshot_json, {});
    r.risk_officer_countersign_attestation_json = parseJsonField(r.risk_officer_countersign_attestation_json, {});
